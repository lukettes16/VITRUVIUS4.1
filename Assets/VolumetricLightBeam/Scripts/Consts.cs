...
namespace VLB
{
    public static class Consts
    {
        ...
        public static class Help
        {
            ...
            public const string UrlLODBeamGroup = UrlBase + "comp-lodbeamgroup" + UrlSuffix;
        ...
        public static class Shadow
        {
            ...
            public static string GetErrorChangeRuntimeDepthMapDepth(VLB.VolumetricShadowHD comp) { return string.Format("Can't change {0} Shadow.depthMapDepth property at runtime after DepthCamera initialization", comp.name); }
        }
